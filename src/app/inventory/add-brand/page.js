...
const Page = () => {
  ...
  return (
    ...
    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
      <h1 className="text-2xl font-bold text-gray-700 mb-4">Add Brand and Products</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-4">
          ...
          <h2 className="text-lg font-semibold text-gray-700">Brand Product List</h2>
          {brand.products.map((product, index) => (
            <div key={index} className="space-y-4 bg-gray-50 p-4 rounded-md shadow-sm">
